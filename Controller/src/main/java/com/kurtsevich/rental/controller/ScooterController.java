...
public class ScooterController {
    ...
    @PutMapping
    public ResponseEntity<Void> add(@RequestBody AddScooterDto addScooterDto) {
    ...
    public ResponseEntity<Void> addRentTermsToScooter(@RequestBody ScooterRentTermsDto scooterRentTermsDto) {
        scooterService.addRentTermsToScooter(scooterRentTermsDto);
        return ResponseEntity.noContent().build();
    }

    @DeleteMapping("/rent-terms")
    public ResponseEntity<Void> deleteRentTermsAtScooter(@RequestBody ScooterRentTermsDto scooterRentTermsDto) {
        scooterService.deleteRentTermsAtScooter(scooterRentTermsDto);
        return ResponseEntity.noContent().build();
    }
