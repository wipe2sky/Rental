...
public class RentTermsController {
    ...
    @PutMapping
    public ResponseEntity<Void> add(@RequestBody RentTermsDto rentTermsDto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> update(@PathVariable Long id, @RequestBody RentTermsDto rentTermsDto){
